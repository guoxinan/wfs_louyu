...
layui.define(["element","jquery"],function(exports){
	...
	//获取二级菜单数据
	Tab.prototype.render = function(title) {
		//显示左侧菜单
		var _this = this;
		var home_li = '';
		home_li += '<li class="layui-nav-item layui-this"><a>';
		home_li += '<i class="layui-icon" data-icon=""></i><cite>'+title+'</cite>';
		home_li += '</a></li>';
		$(".navBar ul").html(home_li).append(_this.navBar(dataStr)).height($(window).height()-210);
