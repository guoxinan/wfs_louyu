<?php /*a:3:{s:56:"D:\project\vfs_bms\application\admin\view\job\index.html";i:1573005997;s:58:"D:\project\vfs_bms\application\admin\view\layout\main.html";i:1573005997;s:57:"D:\project\vfs_bms\application\admin\view\inc\header.html";i:1573005997;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['form', 'table', 'jquery', 'layer', 'upload', 'util'], function () {
        ...
        tablelistobj.tool_obj = {
            lists: {href: "<?php echo url('admin/Job/lists'); ?>", title: '列表'},
            add: {href: "<?php echo url('admin/Job/add'); ?>", title: '添加'},
            edit: {href: "<?php echo url('admin/Job/edit'); ?>", title: '编辑'},
            del: {href: "<?php echo url('admin/Job/del'); ?>", title: '删除'},
            param: {href: "<?php echo url('admin/Job/info'); ?>", title: '详情'},
        };
        tablelistobj.cols = [[
